...
function validate() {
	...
	if(userId.length <2) {
		...
		document.getElementById("idloc").innerHTML = "<font color= green>Valid Id</font>";
		status = true;
	}
	if(email == "") {
...
<h2>Login Page</h2>   
    <div class="login">    
    <form id="login" action = "UserServlet?re=login" method="post" action="" name = "f1" onsubmit="return validate()">
